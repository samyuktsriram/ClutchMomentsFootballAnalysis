...
Documentation of code:
  ...
  8. File_Looper.py : To loop over all the 941 events files in the dataset and prepare them for further analysis, through Beta1.py. Can also be used to find a specific team's games in the dataset.
